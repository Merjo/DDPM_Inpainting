...
class Config:
    def __init__(self):
        ...
        self.clamp_range = (-3.5, 3.5)
        self.clamp_range_ref = None
    ...
    def clamp_range2(self):
        ...
        """
        if self.clamp_range_ref is None:
            ...
            self.clamp_range_ref = (low, high)
        return(self.clamp_range_ref)
