...
class Config:
    def __init__(self):
        ...
        self.optuna_epochs = 1#15#10
        self.optuna_patience = 7
        self.optuna_sample_every = 5
        self.optuna_n_trials = 2# 50
        ...
        self.n_samples = 8
        self.n_hist_samples = 64

        self.sample_every = 1#5
        ...
        self.num_blocks = 2
        self.dropout = 0.06863037218446748
        self.downsample_type = 'residual'
        self.channel_mult = '124'
        ...
        self.lr = 0.0001535124882349191

        
        #model_channels,num_blocks,dropout,downsample_type,channel_mult,attn_config,timesteps,beta_schedule,loss,optimizer,scheduler,lr,loss_value
        
        #128,2,0.06863037218446748,residual,124,none,1000,linear,l1,Adam,ExponentialLR,0.0001535124882349191,0.013303605898702517
