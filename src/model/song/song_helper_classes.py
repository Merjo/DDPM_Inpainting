...
import numpy as np
from src.model.song.song_helper_functions import weight_init
from torch.nn.functional import silu

# ----------------------------  SONG HELPER CLASSES  ----------------------------

class PositionalEmbedding(torch.nn.Module):
    """Positional embedding used in the DDPM++ and ADM architectures."""
...
class FourierEmbedding(torch.nn.Module):
    """Fourier positional embedding used in the NCSN++ architecture."""
